...
This project implements a Handwritten Digit Recognition System using a Convolutional Neural Network (CNN). The model is trained to recognize handwritten digits from 0–9 using the MNIST Dataset.
